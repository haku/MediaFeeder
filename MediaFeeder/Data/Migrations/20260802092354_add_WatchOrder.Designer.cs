...
namespace MediaFeeder.Data.Migrations
{
    ...
    [Migration("20260802092354_add_WatchOrder")]
    partial class add_WatchOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaFeeder.Data.db.VideoTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MediaFeeder.Data.db.VideoTag", b =>
                {
                    b.HasOne("MediaFeeder.Data.db.Video", "Video")
                        .WithMany("Tags")
